...
description: >-
  ...
  verify the suite, or collect a local Appium result.
---
...
executed test count is non-zero and matches the expected inventory in
`AGENTS.md`. The runner always passes `--rerun`; a cached `UP-TO-DATE` result is
